export const APIEndpoints = {
    ...
    AUTH_GATEWAY_URL: 'http://54.147.7.110:3000',
    AUTH_URLs: [
        {
            provider: 'google',
            url: 'http://54.147.7.110:3000/auth/google'
        },
        {
            provider: 'facebook',
            url: 'http://54.147.7.110:3000/auth/facebook'
        },
        {
            provider: 'twitter',
            url: 'http://54.147.7.110:3000/auth/twitter'
        },
        {
            provider: 'linkedin',
            url: 'http://54.147.7.110:3000/auth/linkedin'
        },
        {
            provider: 'line',
            url: 'http://54.147.7.110:3000/auth/line'
        },
        {
            provider: 'email',
            url: 'http://54.147.7.110:3000/local/login'
        }
    ],
